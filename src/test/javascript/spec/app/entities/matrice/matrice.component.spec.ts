...
import { MatriceComponent } from 'app/entities/matrice/matrice.component';
import { MatriceService } from 'app/entities/matrice/matrice.service';
import { Matrice } from 'app/shared/model/matrice.model';

describe('Component Tests', () => {
  describe('Matrice Management Component', () => {
    let comp: MatriceComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(MatriceComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.matrices && comp.matrices[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
